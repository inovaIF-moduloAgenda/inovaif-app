...
export default function Sobre(){
    return(
        ...
        <h1 className='h1-sobre'>InovaIF - Módulo Agenda</h1>
        <div className='box-sobre'> 
            ...
            <p>Para pensar neste software, pesquisadores do Instituto Federal do Triângulo Mineiro – Campus Avançado Uberaba Parque Tecnológico – vêm desenvolvendo o aplicativo InovaIF em parceria com o IFB. Objetiva-se que a ferramenta possa ser utilizada em outros espaços educativos que estejam em transição para este mesmo paradigma inovador.</p>
            ...
            <p>O objetivo principal do projeto é desenvolver artefatos para o módulo agenda  INOVAIF - sistema de gerenciamento educacional para cursos inovadores baseado na experiência de reconfiguração pedagógica do EMI-Eventos do IFB. O desenvolvimento deste sistema permitirá que as alunas coloquem em prática os conhecimentos e habilidades desenvolvidos na sua formação.</p>
            <h2>Referências</h2>
